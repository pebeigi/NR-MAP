#!/usr/bin/env python
"""Evaluate an RLlib checkpoint on TrafficMAR-v0 and optionally record a rollout."""
...
def compute_residual_action(
    ...
    """Sample or take deterministic mean action from the trained RLModule."""
